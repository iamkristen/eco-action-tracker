        ...
        <div className="flex flex-col md:flex-row md:items-center">
          <div className="w-full md:w-1/2 md:pr-12 mb-10 md:mb-0">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild variant="outline" size="lg" className="border-eco-medium hover:bg-eco-light">
                  <Link to="/dashboard">
                    Track My Impact
          ...
          <div className="w-full md:w-1/2 relative">
            <div className="bg-eco-light rounded-2xl p-6 md:p-10 shadow-xl relative z-10">
              ...
              <h3 className="text-xl font-semibold mb-4 text-eco-dark">Start Your Eco Journey Today</h3>
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-white rounded-lg p-4 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Record your recycling, upcycling, and sustainable choices</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">See the environmental difference your actions make</p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Get eco-tokens for sustainable actions and redeem rewards</p>
                  </div>
                </div>
              </div>
              
              <Button asChild className="w-full bg-eco-gradient">
                <Link to="/signup">
                  Join the Community
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
